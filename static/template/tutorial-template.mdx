...
description: A tutorial creation template # A short description of the tutorial, does not show on page, for SEO
...
tags: [PyWeb.io, blog, template] # Change to reflect tutorial content, tags will show at the bottom of the tutorial
keywords: [keywords, SEO] # For SEO
---

Author Name, April 6, 2022

![Optional Image](./woman_computer.png)
...
![Step 2 Image1](./woman2_computer.png)

![Step 2 Image2](./computer_things.png)
...
![Step 3 Image1](./computer_things2.png)
...
![Step 3 Image3](./computer_desk.png)
