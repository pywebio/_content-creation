---
slug: description  # slug is the file path to the blog post after /blog/date-description, should be unique to the post
title: Description # H1 main heading that shows at the top of the blog post
