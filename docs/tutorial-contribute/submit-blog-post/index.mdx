...
You can now begin creating your own blog post! Feel free to improvise and make it your own, the template is not the "law", be creative and have fun but try to follow the general layout of the template as well (thanks :smile:). Note, there is a preview tab next to the Edit file tab that allows you to see how your blog post will appear after being deployed.
