...
description: Tutorial for submitting a tutorial to PyWebIO # include a short description of the blog post. This will not be visible anywhere on the page and is for SEO purposes.
...
keywords: [PyWebIO, tutorial] # include several keywords describing the main topics of the blog post for SEO purposes.
tags: [PyWebIO, tutorial, template] # Change to reflect blog content, tags will show at the bottom of the blog post
---
