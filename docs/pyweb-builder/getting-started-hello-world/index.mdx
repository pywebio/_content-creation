...
sidebar_position: 1
title: Getting Started With PyWeb.io Builder (Hello World)
description: A Tutorial on building a basic Hello World web app with PyWeb.io builder
image: /img/tutorial/pywebio_builder_header.png
...
![PyWeb.io header image](./pywebio_builder_header.png)
...
![PyWeb.io create project](./pywebio_builder_create_project.JPG)
...
![PyWeb.io hello world code](./pywebio_builder_hello_world_code.JPG)
...
It is best practice to use `if __name__ == '__main__':`
`start_server(main, port=8888, debug=True)` as this conditional statement works for both local and PyWeb.io Builder development

:::

To test that the app is working properly, click the <Button backgroundColor='#0f9d58' fontColor='white'>Save & Run</Button> button, enter your name in the input box and click the <Button backgroundColor='#007bff' fontColor='white'>Submit</Button> button. The web preview page should display the "Hello, world!" message and your name.
...
PyWeb.io builder makes deploying an app incredibly simple. Follow the steps below to deploy and view your Hello World app on the web. To stop hosting a web app, simply click the 🚫 icon.
