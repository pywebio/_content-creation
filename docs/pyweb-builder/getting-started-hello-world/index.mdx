...
<Button backgroundColor='#0f9d58' fontColor='white'>Save & Run</Button>
<Button backgroundColor='white' borderStyle='solid' borderColor='blue'>➢ Launch</Button>
...
Before building your first web app, follow the steps below to create a new .py file in your Hello World project.
  ...
  1. Click the open folder 🗁 icon to the left of the green "Save & Run" button
